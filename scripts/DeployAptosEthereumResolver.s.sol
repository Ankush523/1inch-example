...
import "../contracts/src/AptosEthereumResolver.sol";
import "../contracts/src/TestEscrowFactory.sol";

contract DeployAptosEthereumResolver is Script {
    function run() external {
        ...
        AptosEthereumResolver resolver = new AptosEthereumResolver(
            IEscrowFactory(address(factory)),
            IOrderMixin(lopAddress),
            deployer
        );
        
        console.log("AptosEthereumResolver deployed at:", address(resolver));
