...
{-|
Module      : Paths_cardano_cross_chain_swap
...
-- at runtime using the environment variable cardano_cross_chain_swap_bindir.
...
-- environment variable cardano_cross_chain_swap_libdir.
...
-- using the environment variable cardano_cross_chain_swap_dynlibdir.
...
-- runtime using the environment variable cardano_cross_chain_swap_datadir.
...
-- variable cardano_cross_chain_swap_libexedir.
...
-- using the environment variable cardano_cross_chain_swap_sysconfdir.
...
bindir     = "/Users/ankush/.cabal/bin"
libdir     = "/Users/ankush/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace/cardano-cross-chain-swap-0.1.0.0-inplace"
dynlibdir  = "/Users/ankush/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace"
datadir    = "/Users/ankush/.cabal/share/aarch64-osx-ghc-9.12.2-inplace/cardano-cross-chain-swap-0.1.0.0"
libexecdir = "/Users/ankush/.cabal/libexec/aarch64-osx-ghc-9.12.2-inplace/cardano-cross-chain-swap-0.1.0.0"
sysconfdir = "/Users/ankush/.cabal/etc"

getBinDir     = catchIO (getEnv "cardano_cross_chain_swap_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "cardano_cross_chain_swap_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "cardano_cross_chain_swap_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "cardano_cross_chain_swap_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "cardano_cross_chain_swap_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "cardano_cross_chain_swap_sysconfdir") (\_ -> return sysconfdir)
