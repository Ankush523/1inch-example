...
/* package cardano-cross-chain-swap-0.1.0.0 */
#ifndef VERSION_cardano_cross_chain_swap
#define VERSION_cardano_cross_chain_swap "0.1.0.0"
#endif /* VERSION_cardano_cross_chain_swap */
#ifndef MIN_VERSION_cardano_cross_chain_swap
#define MIN_VERSION_cardano_cross_chain_swap(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cardano_cross_chain_swap */
...
#define CURRENT_PACKAGE_KEY "cardano-cross-chain-swap-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "cardano-cross-chain-swap-0.1.0.0-inplace"
